goog.provide('fengshui.models.object3d.Object3D');


/**
 * @constructor
 */
fengshui.models.object3d.Object3D = function( mesh ){
...
fengshui.models.object3d.Object3D.prototype.setData = function( data ) {

	// for pathfinding detection
	this._data['collidable'] = goog.isBoolean( data['collidable'] ) ? data['collidable'] : true;

	// for preload
	this._data['textureurl'] = fengshui.Config['imagePath'] + 'texture/' + data['textureurl'];
...
fengshui.models.object3d.Object3D.prototype.getData = function( name ) {
