...
goog.addDependency('../../../../project/controllers/controls/browsecontrols.js', ['feng.controllers.controls.BrowseControls'], ['feng.controllers.controls.Controls', 'feng.utils.MultiLinearInterpolator', 'feng.utils.Randomizer', 'feng.utils.ThreeUtils', 'feng.views.interactiveobject.InteractiveObject', 'feng.views.sections.controls.ObjectSelector', 'goog.events']);
...
goog.addDependency('../../../../project/views/view3d.js', ['feng.views.View3D'], ['feng.controllers.view3d.CameraController', 'feng.controllers.view3d.ModeController', 'feng.controllers.view3d.View3DController', 'feng.fx.PostProcessing', 'feng.models.Preload', 'feng.views.interactiveobject.InteractiveObject', 'feng.views.interactiveobject.View3DObject', 'goog.dom', 'goog.dom.query', 'goog.events', 'goog.events.EventHandler', 'goog.events.EventTarget']);
goog.addDependency('../../../../project/views/view3dobject/interactiveobject.js', ['feng.views.interactiveobject.InteractiveObject'], ['feng.views.interactiveobject.View3DObject']);
goog.addDependency('../../../../project/views/view3dobject/tipobject.js', ['feng.views.interactiveobject.TipObject'], ['feng.views.interactiveobject.InteractiveObject']);
goog.addDependency('../../../../project/views/view3dobject/view3dobject.js', ['feng.views.interactiveobject.View3DObject'], ['goog.events.EventTarget', 'goog.math.Box']);
