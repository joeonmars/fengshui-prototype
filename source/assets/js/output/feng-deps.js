...
goog.addDependency('../../../../project/controllers/controls/browsecontrols.js', ['feng.controllers.controls.BrowseControls'], ['feng.controllers.controls.Controls', 'feng.controllers.controls.ObjectSelector', 'feng.utils.MultiLinearInterpolator', 'feng.utils.Randomizer', 'feng.utils.ThreeUtils', 'goog.events', 'goog.math']);
...
goog.addDependency('../../../../project/controllers/controls/manipulatecontrols.js', ['feng.controllers.controls.ManipulateControls'], ['feng.controllers.controls.Controls', 'goog.events', 'goog.math']);
goog.addDependency('../../../../project/controllers/controls/objectselector.js', ['feng.controllers.controls.ObjectSelector'], ['goog.events', 'goog.events.EventHandler', 'goog.events.EventTarget']);
...
goog.addDependency('../../../../project/templates/main.soy.js', ['feng.templates.main'], ['feng.templates.debug', 'soy', 'soydata']);
...
goog.addDependency('../../../../project/views/sections/episode.js', ['feng.views.sections.Episode'], ['feng.events', 'feng.views.View3D', 'feng.views.sections.Section', 'goog.dom', 'goog.events.EventTarget']);
goog.addDependency('../../../../project/views/sections/home.js', ['feng.views.sections.Home'], ['feng.events', 'feng.views.Preloader', 'feng.views.sections.Section', 'goog.dom', 'goog.dom.query', 'goog.events.EventTarget']);
goog.addDependency('../../../../project/views/sections/section.js', ['feng.views.sections.Section'], ['feng.controllers.NavigationController', 'feng.events', 'goog.dom', 'goog.dom.query', 'goog.events.EventHandler', 'goog.events.EventTarget']);
...
goog.addDependency('../../../../project/views/view3d.js', ['feng.views.View3D'], ['feng.controllers.view3d.CameraController', 'feng.controllers.view3d.ModeController', 'feng.controllers.view3d.View3DController', 'goog.dom', 'goog.dom.query', 'goog.events', 'goog.events.EventHandler', 'goog.events.EventTarget']);
