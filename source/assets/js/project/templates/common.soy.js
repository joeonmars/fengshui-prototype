...
feng.templates.common.TutorialPopup = function(opt_data, opt_ignored) {
  return feng.templates.common.Popup({classname: 'tutorial', content: '<h1>how to play</h1><div class="line"></div><div class="carousel"><ul class="navigator"><li><button></button></li><li><button></button></li><li><button></button></li></ul><ul class="steps"><li><video></video><p>Drag and click to move around.</p></li><li><video></video><p>Press and hold an item to investigate it.</p></li><li><video></video><p>Click the top of the cube to view from above.</p></li></ul></div><div><div class="loader"><div class="bar"><div class="fill"></div></div><p class="counter">00</p></div>' + feng.templates.common.PrimaryButton({classname: 'skip', icon: 'skip', text: 'skip'}) + '</div>'});
};
