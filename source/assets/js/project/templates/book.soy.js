...
feng.templates.book.Book = function(opt_data, opt_ignored) {
  var output = '<div id="book"><div class="shade"></div><div class="main"><nav><button class="close" data-id="close"></button><button class="tab" data-id="glossary">glossary</button><button class="tab" data-id="tips">tips</button><button class="tab" data-id="help">help</button><button class="tab" data-id="about">about</button></nav><div class="pages"><section class="glossary"><div class="wrapper"><div class="scroller"><div class="inner">';
  ...
  output += '</div></div></div></section><section class="tips"><div class="wrapper"><div class="scroller"><div class="inner"><ul>';
