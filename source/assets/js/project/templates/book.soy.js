...
feng.templates.book.Book = function(opt_data, opt_ignored) {
  ...
  output += '</div></div></div></section><section class="tips" data-id="tips"><div class="shade"></div><div class="wrapper"><div class="scroller"><div class="inner"><ul>';
