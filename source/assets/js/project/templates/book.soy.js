...
feng.templates.book.Book = function(opt_data, opt_ignored) {
  ...
  for (var tipIndex6 = 0; tipIndex6 < tipListLen6; tipIndex6++) {
    ...
    output += '<li class="tip-module" data-tip-id="' + tipData6.id + '"><figure class="cover" data-src="' + tipData6.cover + '"><div class="curtain"><div class="wrapper"><div class="icon icon-' + tipData6.icon + '"></div><h1>' + tipData6.name + '</h1><h2><span>Found in</span> ' + tipData6.character + '\'s ' + tipData6.sectionId + '</h2></div></div><ul class="share"><li><a href="#" class="icon icon-facebook"></a></li><li><a href="#" class="icon icon-twitter"></a></li><li><a href="#" class="icon icon-google"></a></li></ul><button>View</button></figure></li>';
  }
