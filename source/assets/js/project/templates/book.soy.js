...
feng.templates.book.Book = function(opt_data, opt_ignored) {
  ...
  for (var tipIndex25 = 0; tipIndex25 < tipListLen25; tipIndex25++) {
    ...
    output += '<li class="tip ' + ((tipData25.unlocked == true) ? 'unlocked' : 'locked') + '" data-tip-id="' + tipData25.id + '"><figure><div class="icon icon-' + tipData25.id + '"></div><figcaption><h1>' + tipData25.name + '<div class="share"><div class="icon icon-share"></div><ul class="slider"><li><a href="#" class="icon icon-facebook"></a></li><li><a href="#" class="icon icon-twitter"></a></li><li><a href="#" class="icon icon-google"></a></li></ul></div></h1><p>' + tipData25.description + '</p></figcaption></figure></li>';
  }
