...
feng.templates.main.EpisodeSection = function(opt_data, opt_ignored) {
  ...
  var tipList417 = opt_data.tips;
  var tipListLen417 = tipList417.length;
  for (var tipIndex417 = 0; tipIndex417 < tipListLen417; tipIndex417++) {
    var tipData417 = tipList417[tipIndex417];
    output += feng.templates.controls.Tooltip({tip: tipData417});
  }
