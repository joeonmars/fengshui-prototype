...
feng.templates.main.EpisodeSection = function(opt_data, opt_ignored) {
  ...
  var tipList474 = opt_data.tips;
  var tipListLen474 = tipList474.length;
  for (var tipIndex474 = 0; tipIndex474 < tipListLen474; tipIndex474++) {
    var tipData474 = tipList474[tipIndex474];
    output += feng.templates.controls.Tooltip({tip: tipData474});
  }
