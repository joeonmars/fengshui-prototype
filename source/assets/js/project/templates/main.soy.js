...
feng.templates.main.Main = function(opt_data, opt_ignored) {
  return '<div id="main"><div class="section" id="home"><div class="inner"><section id="main-preloader">' + feng.templates.common.Disc({content: feng.templates.common.FengshuiLogo(null) + '<div class="bar"><div class="fill"></div></div><p class="counter">00</p>'}) + '</section><section id="main-intro">' + feng.templates.common.PrimaryButton({icon: 'yes', text: 'continue'}) + '</section><section id="main-episode-selection"></section></div></div><div id="episode-selection-overlay"></div><button id="episode-button"></button><ul id="main-options"><li><button class="howtoplay"><div class="fill"></div><div class="icon"><div></div><div></div></div></button></li><li><button class="fullscreen"><div class="fill"></div><div class="icon"><div></div><div></div></div></button></li><li><button class="sound"><div class="fill"></div><div class="icon"><div></div><div></div></div></button></li><li class="share"><button><div class="fill"></div><div class="icon"><div></div><div></div></div></button><div class="slider"><div class="buttons"><a class="facebook"></a><a class="twitter"></a><a class="google"></a></div></div></li></ul></div>' + ((opt_data.debug != false) ? feng.templates.debug.Debugger(null) : '');
};
