...
feng.templates.main.EpisodeSection = function(opt_data, opt_ignored) {
  ...
  var tipList504 = opt_data.tips;
  var tipListLen504 = tipList504.length;
  for (var tipIndex504 = 0; tipIndex504 < tipListLen504; tipIndex504++) {
    var tipData504 = tipList504[tipIndex504];
    output += feng.templates.controls.Tooltip({tip: tipData504});
  }
