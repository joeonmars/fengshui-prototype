...
feng.templates.main.EpisodeSection = function(opt_data, opt_ignored) {
  return '<div class="section episode" id="' + opt_data.id + '"><div class="hud"><div class="overlays"><div class="tutorial-overlay"></div><div class="opening-overlay" style="display:none">' + feng.templates.common.Popup({content: '<h1></h1><div class="line"></div><p></p>' + feng.templates.common.PrimaryButton({icon: 'yes', text: 'got it'}) + '<div class="character"></div>'}) + '</div><div class="continue-overlay" style="display:none">' + feng.templates.common.Popup({content: '<h1></h1><div class="line"></div><p></p>' + feng.templates.common.PrimaryButton({icon: 'yes', text: 'continue exploring'}) + feng.templates.common.PrimaryButton({icon: 'yes', text: 'visit another residence'}) + '<div class="character"></div>'}) + '</div><div class="ending-overlay" style="display:none">' + feng.templates.common.Popup({content: '<h1></h1><div class="line"></div><p></p>' + feng.templates.common.PrimaryButton({icon: 'yes', text: 'ok'}) + '<div class="character"></div>'}) + '</div></div><div class="controls">' + feng.templates.controls.Compass(null) + feng.templates.controls.Book(null) + feng.templates.controls.Reminder(opt_data) + feng.templates.controls.ObjectSelector(null) + feng.templates.controls.ObjectBox(null) + feng.templates.controls.Manipulator(null) + feng.templates.controls.ProgressBar(opt_data) + '</div><div class="captions"></div></div><div class="sceneContainer"></div></div>';
};
