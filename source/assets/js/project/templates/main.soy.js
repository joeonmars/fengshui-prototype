...
feng.templates.main.SceneSelection = function(opt_data, opt_ignored) {
  return '<div class="scene-selection"><div class="scene studio"><div class="shade"></div><div class="overlay"><div class="prompt">' + feng.templates.common.Disc({content: '<div class="location"><p>LOCATION</p><div class="line"></div></div><h1>Ollie\'s<br>Studio</h1><p>Ollie is a fashion designer.<br>She lives in a small studio in<br>the noisy downtown area.<br>Give her some Fengshui tips!</p>' + feng.templates.common.PrimaryButton({href: '#studio', icon: 'yes', text: 'start'})}) + '</div><div class="people"></div></div></div><div class="scene townhouse"><div class="shade"></div><div class="overlay"><div class="prompt">' + feng.templates.common.Disc({content: '<div class="location"><p>LOCATION</p><div class="line"></div></div><h1>Joanna\'s<br>Townhouse</h1><p>Joanna lives in a Townhouse,<br>She was married with<br>a preschool kid<br>both living at home.</p>' + feng.templates.common.PrimaryButton({href: '#studio', icon: 'yes', text: 'start'})}) + '</div><div class="people"></div></div></div><div class="ui">' + feng.templates.main.Logo(null) + '</div></div>';
};
